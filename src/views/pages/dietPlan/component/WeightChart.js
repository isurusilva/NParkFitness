...
const WeightChart = ({ size, data, weightLoss }) => {
    theme = useTheme();
    ...
    const [weightChart, setWeightChart] = React.useState([0, 0, 0, 0, 0]);
    ...
    return (
        <>
            <SubCard
                ...
                title={`Weight ${weightLoss > 0 ? 'Gain' : 'Loss'} is ${Math.abs(weightLoss)} kg`}
            >
